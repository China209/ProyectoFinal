...
public class Ventana extends JFrame {
    ...
    ModeloDeTabla hojaCalculo = new ModeloDeTabla();//Llamamos al método general del modelo de la tabla
    ...
    public void EventosMenu() {
        ...
        miNuevo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Ventana.this.hojaCalculo.nuevo();
                panelScroll.repaint();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (iResultado == JOptionPane.YES_OPTION) {
                    ...
                    if (iOpcion == JFileChooser.APPROVE_OPTION) {
                        ...
                        jfcArchivo = null;
                        try {
                            FileInputStream fins = new FileInputStream(fArchivo);
        ...
        /*Este evento fue hecho por Cyndi Medina y Ester Guamuch*/
